...
def preprocess():
    ...
    df_clean1 = df_clean.drop(['Price_per_sq', 'Terrace', 'Garden', 'Furnished', 'Open_fireplace'], axis='columns')
    df_clean2 = df_clean1.replace("Liège", "Liege")
    df_clean2.to_csv('clean_df.csv')
    # return df_clean2
